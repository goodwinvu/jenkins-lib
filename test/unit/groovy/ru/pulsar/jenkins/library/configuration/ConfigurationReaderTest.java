...
class ConfigurationReaderTest {
  ...
  void testCreateJobConfigurationObject() throws IOException {
    ...
    assertThat(jobConfiguration.getPathEDTCliDef()).isEqualTo("/opt/1C/1CE/components/");
  ...
  @Test
  void testuseEDTCli() throws IOException {
    // given
    String config = IOUtils.resourceToString(
            "jobConfiguration.json",
            StandardCharsets.UTF_8,
    ...
    // then
    assertThat(jobConfiguration.useEDTCli()).isFalse();
  }

  @Test
  void testgetEDTPath() throws IOException {
    // given
    String config = IOUtils.resourceToString(
            "jobConfiguration.json",
            StandardCharsets.UTF_8,
    ...
    // then
    assertThat(jobConfiguration.getEDTPath()).isEqualTo("/opt/1C/1CE/components/");
  }
